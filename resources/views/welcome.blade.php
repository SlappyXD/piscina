...
<head>
    ...
    <title>Academia de Natación - Nada Bien</title>
    <!-- Custom CSS -->
...
<body>
                    ...
                    <div class="navbar-brand">
                        ...
                        <a href="index.html">
                            <b class="logo-icon">
                                ...
                                <!-- Light Logo icon -->
                                <img src="{{asset('plantilla/assets/images/piscina.jpeg')}}" alt="homepage" class="light-logo" />
                            </b>
                            <!--End Logo icon -->
                            <!-- Logo text -->
                        ...
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle" href="javascript:void(0)" data-toggle="dropdown"
                                ...
                                <span class="ml-2 d-none d-lg-inline-block"><span>Hola,</span> <span
                                        class="text-dark">Admin1</span> <i data-feather="chevron-down"
                            ...
                            <div class="dropdown-menu dropdown-menu-right user-dd animated flipInY">
                                ...
                                <a class="dropdown-item" href="javascript:void(0)"><i data-feather="power"
                                    ...
                                    Cerrar sesión</a>
                                <div class="dropdown-divider"></div>
                                {{-- <div class="pl-4 p-3"><a href="javascript:void(0)" class="btn btn-sm btn-info">Ver perfil</a></div> --}}
                            </div>
                        </li>
                        <!-- ============================================================== -->
                        <!-- User profile and search -->
            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-7 align-self-center">
                        <h3 class="page-title text-truncate text-dark font-weight-medium mb-1">Bienvenido Admin1...!!!</h3>
    ...
    <script src="{{asset('plantilla/assets/libs/chartist-plugin-tooltips/dist/chartist-plugin-tooltip.min.js')}}"></script>
